...
<body style="user-select: none">
    ...
    <header class="w3-container w3-center" style="padding:36vh 16px; background-color:rgb(225, 231, 215);">
        <h1 class="w3-margin w3-jumbo" style="color:rgb(225, 16, 16)">Inspiring Provider</h1>
        ...
        <div class="w3-row-padding w3-container"
            ...
            <div class="w3-content">
                ...
                <div class="w3-rest w3-center">
                    <img class="element" src="assets/<?php echo $personalitiesContent[$j][1] ?>" alt="Inspire others!  "
